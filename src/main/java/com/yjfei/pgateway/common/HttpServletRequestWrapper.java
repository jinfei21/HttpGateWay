...
public class HttpServletRequestWrapper implements HttpServletRequest {
	...
	private void parseRequest() throws IOException {
		...
		Map<String, List<String>> query = HTTPRequestUtils.getQueryParams();
		if (query != null) {
		...
		if (req.getContentLength() > 0) {
			...
			final String transferEncoding = req.getHeader(GateHeaders.TRANSFER_ENCODING);
			if (transferEncoding != null && transferEncoding.equals(GateHeaders.CHUNKED))
