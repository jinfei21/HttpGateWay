package com.yjfei.pgateway.context;
...
import com.yjfei.pgateway.util.DeepCopy;
...
public class RequestContext extends ConcurrentHashMap<String, Object> {
	 ...
	 * @return
	 */
	public boolean getGateEngineRan() {
		return getBoolean("gateEngineRan");
	}

	/**
	 * sets gateEngineRan to true
	 */
	public void setGateEngineRan() {
		put("gateEngineRan", true);
	}
	 ...
	 * to the client.
	 * <p>
	 * It is almost generated by gatekeeper, Eq. static resource or the error
	 ...
	 * @return
	 */
	public boolean sendGateResponse() {
		return getBoolean("sendGateResponse", true);
	}

	/**
	 * sets the sendGateResponse boolean
	 *
	 * @param bSend
	 */
	public void setSendGateResponse(boolean bSend) {
		set("sendGateResponse", Boolean.valueOf(bSend));
	}
	 ...
	 * @param value
	 */
	public void addGateRequestHeader(String name, String value) {
		getGateRequestHeaders().put(name.toLowerCase(), value);
	}
	 ...
	 * @return the list of requestHeaders to be sent to the origin
	 */
	public Map<String, String> getGateRequestHeaders() {
		if (get("gateRequestHeaders") == null) {
			HashMap<String, String> gateRequestHeaders = new HashMap<String, String>();
			putIfAbsent("gateRequestHeaders", gateRequestHeaders);
		}
		return (Map<String, String>) get("gateRequestHeaders");
	}
	 ...
	 * @param value
	 */
	public void addGateResponseHeader(String name, String value) {
		getGateResponseHeaders().add(new Pair<String, String>(name, value));
	}
	 ...
	 */
	public List<Pair<String, String>> getGateResponseHeaders() {
		if (get("gateResponseHeaders") == null) {
			List<Pair<String, String>> gateRequestHeaders = new ArrayList<Pair<String, String>>();
			putIfAbsent("gateResponseHeaders", gateRequestHeaders);
		}
		return (List<Pair<String, String>>) get("gateResponseHeaders");
	}
	...
	public boolean isGzipRequested() {
		final String requestEncoding = this.getRequest().getHeader(GateHeaders.ACCEPT_ENCODING);
