...
import com.yjfei.pgateway.common.ExecutionStatus;
import com.yjfei.pgateway.common.GateFilterResult;
import com.yjfei.pgateway.common.IGateFilter;
...
public abstract class GateFilter implements IGateFilter, Comparable<GateFilter> {
	...
	public GateFilterResult runFilter() {
		...
		boolean is =  ctx.getRouteUrl() != null && ctx.sendGateResponse();
