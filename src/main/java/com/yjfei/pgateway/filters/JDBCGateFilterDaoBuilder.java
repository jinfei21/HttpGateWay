...
import com.yjfei.pgateway.common.IGateFilterDaoBuilder;
...
public class JDBCGateFilterDaoBuilder implements IGateFilterDaoBuilder {
	...
	public IGateFilterDao build() {
        return new HystrixGateFilterDao(new JDBCGateFilterDao(filterTable, dataSource, Constants.ApplicationName));
